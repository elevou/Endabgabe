...
(function (GardenSimulation) {
    var Salat = /** @class */ (function (_super) {
        __extends(Salat, _super);
        function Salat(_row, _collum) {
            var _this = _super.call(this, _row, _collum) || this;
            _this.images = [GardenSimulation.Load.salatS, GardenSimulation.Load.salatM, GardenSimulation.Load.salatB];
